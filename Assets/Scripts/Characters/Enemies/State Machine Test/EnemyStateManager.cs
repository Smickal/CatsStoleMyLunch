...
public class EnemyStateManager : MonoBehaviour
{
    ...
    [SerializeField] float requireDistanceToPlayer = 1.4f;
    ...
    private void Awake()
    {
        ...
        AttackState = new EnemyAttackState(col,attackDamage,attackSpeed,moveForce, attHitbox,player,anim,requireDistanceToPlayer);
