...
public class EnemyAttackState : EnemyStateBase
{
    ...
    float requireDistanceToPlayer;

    public EnemyAttackState(BehaviourCollider col, float attackDamage, float attackSpeed, float moveSpeed, BoxCollider2D boxCol, Player player, Animator anim, float rtd)
    {
        this.col = col;
    ...
    void Attack(EnemyStateManager enemy)
    {
        ...
        //Gebuk musuh
        //Debug.Log(distanceToPlayer);
        if (distanceToPlayer <= requireDistanceToPlayer)
        {
